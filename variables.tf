...
variable "container_images" {
  ...
  default = {
    calico                  = "quay.io/calico/node:v3.17.2"
    calico_cni              = "quay.io/calico/cni:v3.17.2"
    ...
    kube_apiserver          = "k8s.gcr.io/kube-apiserver:v1.20.3"
    kube_controller_manager = "k8s.gcr.io/kube-controller-manager:v1.20.3"
    kube_scheduler          = "k8s.gcr.io/kube-scheduler:v1.20.3"
    kube_proxy              = "k8s.gcr.io/kube-proxy:v1.20.3"
  }
}
