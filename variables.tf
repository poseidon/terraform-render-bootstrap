...
variable "container_images" {
  ...
  default = {
    calico                  = "quay.io/calico/node:v3.18.1"
    ...
    kube_apiserver          = "k8s.gcr.io/kube-apiserver:v1.21.0"
    kube_controller_manager = "k8s.gcr.io/kube-controller-manager:v1.21.0"
    kube_scheduler          = "k8s.gcr.io/kube-scheduler:v1.21.0"
    kube_proxy              = "k8s.gcr.io/kube-proxy:v1.21.0"
  }
}
