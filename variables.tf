...
variable "container_images" {
  ...
  default = {
    ...
    cilium_agent            = "quay.io/cilium/cilium:v1.14.2"
    cilium_operator         = "quay.io/cilium/operator-generic:v1.14.2"
    ...
    kube_apiserver          = "registry.k8s.io/kube-apiserver:v1.28.3"
    kube_controller_manager = "registry.k8s.io/kube-controller-manager:v1.28.3"
    kube_scheduler          = "registry.k8s.io/kube-scheduler:v1.28.3"
    kube_proxy              = "registry.k8s.io/kube-proxy:v1.28.3"
  }
}
