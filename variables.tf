...
variable "container_images" {
  ...
  default = {
    ...
    kube_controller_manager = "k8s.gcr.io/kube-controller-manager:v1.20.5"
    kube_scheduler          = "k8s.gcr.io/kube-scheduler:v1.20.5"
    kube_proxy              = "k8s.gcr.io/kube-proxy:v1.20.5"
  }
}
