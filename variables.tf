...
variable "container_images" {
  ...
  default = {
    calico                  = "quay.io/calico/node:v3.15.3"
    calico_cni              = "quay.io/calico/cni:v3.15.3"
    coredns                 = "k8s.gcr.io/coredns:1.7.0"
    flannel                 = "quay.io/coreos/flannel:v0.13.0-rc2"
    flannel_cni             = "quay.io/poseidon/flannel-cni:v0.4.1"
    kube_apiserver          = "k8s.gcr.io/kube-apiserver:v1.19.1"
    kube_controller_manager = "k8s.gcr.io/kube-controller-manager:v1.19.1"
    kube_scheduler          = "k8s.gcr.io/kube-scheduler:v1.19.1"
    kube_proxy              = "k8s.gcr.io/kube-proxy:v1.19.1"
    # experimental
