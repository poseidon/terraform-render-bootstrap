...
variable "container_images" {
  ...
  default = {
    cilium_agent            = "quay.io/cilium/cilium:v1.17.3"
    cilium_operator         = "quay.io/cilium/operator-generic:v1.17.3"
    ...
    kube_apiserver          = "registry.k8s.io/kube-apiserver:v1.33.0"
    kube_controller_manager = "registry.k8s.io/kube-controller-manager:v1.33.0"
    kube_scheduler          = "registry.k8s.io/kube-scheduler:v1.33.0"
    kube_proxy              = "registry.k8s.io/kube-proxy:v1.33.0"
  }
}
